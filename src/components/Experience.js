                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} md={6} lg={6}>
                        <div className='py-4 textBlurbs'>
                            <h2><span className='thirdColorBG text-xl px-1'>FRONT END WEB DEVELOPER</span> ZANIBONI LIGHTING</h2>
                            <p>For years, Zaniboni Lighting has been developing a line of products aimed at the us architectural market.</p>
                        </div>
                        <div className='py-4 textBlurbs'>
                            <h2 className='pb-2'><span className='thirdColorBG text-xl px-1'>JR FRONT END WEB DEVELOPER</span> THE WAVE OF CLEARWATER</h2>
                        ...
                        <div className='py-4 textBlurbs' >
                            <h2 className='pb-2'><span className='thirdColorBG text-xl px-1'>JR FRONT END WEB DEVELOPER / CONTENT DEVELOPER</span> H2 IT SOLUTIONS</h2>
