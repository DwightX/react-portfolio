...
const Projects = (props) => {
  return (
    ...
    <div id="project__block" className="container mx-auto pt-24 max-w-screen-2xl">
            ...
            <div className="py-4 px-4 textBlurbs jobBlob">
              ...
              <div className="flex">
                <div className="flex items-center">
                  ...
                  <span class="media__stack-details laguageText">React Netlify</span>
                </div>
              </div>
            </div>
            <div className="py-4 px-4 textBlurbs jobBlob">
              ...
              <p>
                More practice with React to create a responsive Netflix clone.
              </p>
              <div className="flex">
                <div className="flex items-center">
                  <svg class="media__stack-icon" viewBox="0 0 24 24" role="img">
